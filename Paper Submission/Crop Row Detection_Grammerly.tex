...
\subsubsection{Linear Regression}\label{Linear Regression}\leavevmode
...
\subsubsection{Hough Transform}\label{Hough Transform}\leavevmode
...
\subsection{Path Waypoint Detection}\label{Path Waypoint Generation}
